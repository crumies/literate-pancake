...
final class AppSettings: ObservableObject {
    ...
    @AppStorage("updateInterval") var updateIntervalRaw: Double = 1.0
    ...
    var updateInterval: UpdateInterval {
        get { UpdateInterval(rawValue: updateIntervalRaw) ?? .one }
...
struct TelemetryHistory {
    ...
    mutating func append(_ t: Telemetry, currentValue: Double) {
